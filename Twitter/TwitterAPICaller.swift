...
class TwitterAPICaller: BDBOAuth1SessionManager {    
    static let client = TwitterAPICaller(baseURL: URL(string: "https://api.twitter.com"), consumerKey: "q2UMlWKwEXznqGuQEduAg6eBz", consumerSecret: "dS3FtRGJTnUTksSUM5qGB1G48Lqo5B4yletW0KDL2LZq5xhGkH")
    var loginSuccess: (() -> ())?
    ...
    func favoritedTweet(tweetid:Int,success: @escaping () -> (), failure: @escaping (Error)-> ()) {
    ...
    func unFavoritedTweet(tweetid:Int,success: @escaping () -> (), failure: @escaping (Error)-> ()) {
